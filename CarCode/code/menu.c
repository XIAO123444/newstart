...
MENU menu[] = 
{
    ...
    {1, "function", 0, 140, {.param_float=&default_float}, catlog, NULL},
        {2,"Beacon",0,20,{.param_float=&default_float}, catlog, NULL},
            {3,"group1",0,20,{.param_float=&default_float}, catlogandfunction, Beacon_Function},
                {4,"Beacon_num",100,20,{.param_uint8=&Beacon_num[0]}, param_uint8, NULL},
                {4,"Beacon_INFO_1",0,40,{.param_float=&default_float}, catlog, NULL},
                    {5,"X",80,20,{.param_float=&Beacon_raw_info[0].x}, param_float, NULL},
                    {5,"Y",80,40,{.param_float=&Beacon_raw_info[0].y}, param_float, NULL},
                    {5,"ONOFF",80,60,{.param_int16=&Beacon_raw_info[0].lighton}, on_off, NULL},
                {4,"Beacon_INFO_2",0,60,{.param_float=&default_float}, catlog, NULL},
                    {5,"X",80,20,{.param_float=&Beacon_raw_info[1].x}, param_float, NULL},
                    {5,"Y",80,40,{.param_float=&Beacon_raw_info[1].y}, param_float, NULL},
                    {5,"ONOFF",80,60,{.param_int16=&Beacon_raw_info[1].lighton}, on_off, NULL},
                {4,"Beacon_INFO_3",0,80,{.param_float=&default_float}, catlog, NULL},
                    {5,"X",80,20,{.param_float=&Beacon_raw_info[2].x}, param_float, NULL},
                    {5,"Y",80,40,{.param_float=&Beacon_raw_info[2].y}, param_float, NULL},
                    {5,"ONOFF",80,60,{.param_int16=&Beacon_raw_info[2].lighton}, on_off, NULL},
                {4,"Beacon_INFO_4",0,100,{.param_float=&default_float}, catlog, NULL},
                    {5,"X",80,20,{.param_float=&Beacon_raw_info[3].x}, param_float, NULL},
                    {5,"Y",80,40,{.param_float=&Beacon_raw_info[3].y}, param_float, NULL},
                    {5,"ONOFF",80,60,{.param_int16=&Beacon_raw_info[3].lighton}, on_off, NULL},
                {4,"Beacon_INFO_5",0,120,{.param_float=&default_float}, catlog, NULL},
                    {5,"X",80,20,{.param_float=&Beacon_raw_info[4].x}, param_float, NULL},
                    {5,"Y",80,40,{.param_float=&Beacon_raw_info[4].y}, param_float, NULL},
                    {5,"ONOFF",80,60,{.param_int16=&Beacon_raw_info[4].lighton}, on_off, NULL},
                {4,"Beacon_INFO_6",0,140,{.param_float=&default_float}, catlog, NULL},
                    {5,"X",80,20,{.param_float=&Beacon_raw_info[5].x}, param_float, NULL},
                    {5,"Y",80,40,{.param_float=&Beacon_raw_info[5].y}, param_float, NULL},
                    {5,"ONOFF",80,60,{.param_int16=&Beacon_raw_info[5].lighton}, on_off, NULL},
                {4,"Beacon_INFO_7",0,160,{.param_float=&default_float}, catlog, NULL},
                    {5,"X",80,20,{.param_float=&Beacon_raw_info[6].x}, param_float, NULL},
                    {5,"Y",80,40,{.param_float=&Beacon_raw_info[6].y}, param_float, NULL},
                    {5,"ONOFF",80,60,{.param_int16=&Beacon_raw_info[6].lighton}, on_off, NULL},
                {4,"Beacon_INFO_8",0,180,{.param_float=&default_float}, catlog, NULL},
                    {5,"X",80,20,{.param_float=&Beacon_raw_info[7].x}, param_float, NULL},
                    {5,"Y",80,40,{.param_float=&Beacon_raw_info[7].y}, param_float, NULL},
                    {5,"ONOFF",80,60,{.param_int16=&Beacon_raw_info[7].lighton}, on_off, NULL},
                {4,"Beacon_INFO_9",0,200,{.param_float=&default_float}, catlog, NULL},
                    {5,"X",80,20,{.param_float=&Beacon_raw_info[8].x}, param_float, NULL},
                    {5,"Y",80,40,{.param_float=&Beacon_raw_info[8].y}, param_float, NULL},
                    {5,"ONOFF",80,60,{.param_int16=&Beacon_raw_info[8].lighton}, on_off, NULL},
                {4,"Beacon_INFO_10",0,220,{.param_float=&default_float}, catlog, NULL},
                    {5,"X",80,20,{.param_float=&Beacon_raw_info[9].x}, param_float, NULL},
                    {5,"Y",80,40,{.param_float=&Beacon_raw_info[9].y}, param_float, NULL},
                    {5,"ONOFF",80,60,{.param_int16=&Beacon_raw_info[9].lighton}, on_off, NULL},
