...
#define IPS200_SCL_PIN                  ( A5 )                                  // 软件 SPI SCK 引脚
#define IPS200_SDA_PIN                  ( A7 )                                  // 软件 SPI MOSI 引脚
//====================================================软件 SPI 驱动====================================================
#else
//====================================================硬件 SPI 驱动====================================================
// 如果使用的是单排排针的两寸屏幕 SPI 驱动控制引脚 可以修改
...
#define IPS200_SCL_PIN_SPI              ( SPI1_SCK_A5      )                    // 硬件 SPI SCK 引脚
#define IPS200_SDA_PIN_SPI              ( SPI1_MOSI_A7     )                    // 硬件 SPI MOSI 引脚
//====================================================硬件 SPI 驱动====================================================
#endif
// 如果使用的是单排排针的两寸屏幕 SPI 驱动控制引脚 可以修改
#define IPS200_RST_PIN_SPI              ( A6 )                                  // 液晶复位引脚定义
#define IPS200_DC_PIN_SPI               ( D0 )                                  // 液晶命令位引脚定义
#define IPS200_CS_PIN_SPI               ( A4 )
#define IPS200_BLk_PIN_SPI              ( D1 )

// 如果使用的是双排排针的两寸屏幕 并口驱动控制引脚 可以修改
#define IPS200_RD_PIN_PARALLEL8         ( A5 )
#define IPS200_WR_PIN_PARALLEL8         ( A7 )
#define IPS200_RS_PIN_PARALLEL8         ( A6 )
#define IPS200_RST_PIN_PARALLEL8        ( D0 )
#define IPS200_CS_PIN_PARALLEL8         ( A4 )
#define IPS200_BL_PIN_PARALLEL8         ( D1 )

// 并口驱动数据引脚 可以修改 如果你的屏幕是双排排针 这里的引脚用得到 必须要连续八个引脚
#define IPS200_D0_PIN_PARALLEL8         ( D8  )
#define IPS200_D1_PIN_PARALLEL8         ( D9  )
#define IPS200_D2_PIN_PARALLEL8         ( D10 )
#define IPS200_D3_PIN_PARALLEL8         ( D11 )
